...
MAIN_CLASS=com.netto.schedule.demo.ScheduleDemoLauncher
...
if [ -z "$OPTS_MEMORY" ] ; then
    OPTS_MEMORY="-server -Xms2G -Xmx2G  -Dio.netty.leakDetection.level=advanced -Xss512k -XX:MetaspaceSize=256M -XX:MaxMetaspaceSize=256M"
fi
